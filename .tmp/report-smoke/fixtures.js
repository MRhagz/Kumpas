...
exports.demoRankedRecommendationValidationErrors = exports.demoRankedRecommendationList = exports.demoStudentProfile = void 0;
const types_1 = require("@/lib/report/types");
exports.demoStudentProfile = {
...
exports.demoRankedRecommendationList = {
    sessionId: exports.demoStudentProfile.sessionId,
    ...
    recommendations: [
        {
            ...
            reasoningSummary: "The student's technical interests and reasoning strengths align strongly with software development, while local and remote demand keep the path practical despite financial constraints.",
            keySignals: [
        ...
        },
        {
            ...
            reasoningSummary: "Data analysis is a strong adjacent option because it uses the student's quantitative strengths and can be entered through portfolio-based training, though communication skill development should be monitored.",
            keySignals: [
        ...
        },
        {
            ...
            reasoningSummary: "IT support is a feasible near-term option because it has accessible certifications and practical entry points, but it may be less aligned with the student's long-term software development interests.",
            keySignals: [
...
exports.demoRankedRecommendationValidationErrors = (0, types_1.validateRankedRecommendationList)(exports.demoRankedRecommendationList);
